...
from app.game.engine import GameEngine, GameState, GameError
...
def make_move(game_id):
    ...
    try:
        move = parse_move_data(data['move'])  # write parse_move_data
        new_state = GameEngine.apply_action(current_state, move)
...
def create_game():
    ...
    game = Game(
        player1_id=user_id,
        player2_id=None if opponent_type == 'ai' else None,  # set to AI_PLAYER_ID constant
